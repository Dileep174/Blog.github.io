                            ...
                            <div class="col-lg-12 mb-5">
                                <div class="single-blog-item">
                                    ...
                                    <div class="blog-item-content bg-white p-5">
                                        ...
                                        <h2 class="mt-3 mb-4"><a href="blog-single.html">Improve design with
                                                typography?</a></h2>
                                        ...
                                        <h3 class="quote">A brand for a company is like a reputation for a person. You
                                            earn reputation by trying to do hard things well.</h3>
                                    ...
                                    <ul class="comment-tree list-unstyled">
                                        <li class="mb-5">
                                            <div class="comment-area-box">
                                                <img alt="" src="/src/assets/images/blog/test1.jpg"
                                        ...
                                        <li>
                                            <div class="comment-area-box">
                                                <img alt="" src="/src/assets/images/blog/test2.jpg"
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-wrap">
                            ...
                            <div class="sidebar-widget card border-0 mb-3">
                                <img src="/src/assets/images/blog/blog-author.jpg" alt="" class="img-fluid">
                            ...
                            <div class="sidebar-widget latest-post card border-0 p-4 mb-3">
                                ...
                                <div class="media border-bottom py-3">
                                    <a href="#"><img class="mr-4" src="/src/assets/images/blog/bt-3.jpg" alt=""></a>
                                ...
                                <div class="media border-bottom py-3">
                                    <a href="#"><img class="mr-4" src="/src/assets/images/blog/bt-2.jpg" alt=""></a>
                                    <div class="media-body">
                                ...
                                <div class="media py-3">
                                    <a href="#"><img class="mr-4" src="/src/assets/images/blog/bt-1.jpg" alt=""></a>
                                    <div class="media-body">
